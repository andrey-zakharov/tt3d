...
ELSE (PROTOBUF_LIBRARY AND PROTOBUF_INCLUDE_DIR AND PROTOBUF_PROTOC_EXECUTABLE)
  ...
  FIND_PATH(PROTOBUF_INCLUDE_DIR protobuf/stubs/common.h
...
IF (PROTOBUF_FOUND)
  ...
  FUNCTION(WRAP_PROTO VAR)
    ...
    SET(${VAR})
    FOREACH(FIL ${ARGN})
      GET_FILENAME_COMPONENT(SUB_PATH ${FIL} PATH)
      GET_FILENAME_COMPONENT(ABS_FIL ${FIL} ABSOLUTE)
      GET_FILENAME_COMPONENT(FIL_WE ${FIL} NAME_WE)
      LIST(APPEND ${VAR} "${CMAKE_CURRENT_BINARY_DIR}/${SUB_PATH}/${FIL_WE}.pb.cc")
      LIST(APPEND INCL "${CMAKE_CURRENT_BINARY_DIR}/${SUB_PATH}/${FIL_WE}.pb.h")

      ADD_CUSTOM_COMMAND(
        OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/${SUB_PATH}/${FIL_WE}.pb.cc" "${CMAKE_CURRENT_BINARY_DIR}/${SUB_PATH}/${FIL_WE}.pb.h"
